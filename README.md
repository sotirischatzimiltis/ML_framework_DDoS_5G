## Title: An ML-Driven Detection Framework for 5G Core DDoS Attacks Using Near Real-Time RIC
### Abstract:
...
### Training 
1. The following [script](https://github.com/sotirischatzimiltis/ML_framework_DDoS_5G/blob/main/Scripts/Finetuning_experiments_06.ipynb) performs various experiments to finetune the LSTM architecture, find the ideal number of featues for the experiments, the ideal window size and the best ratio of sampled data. 
